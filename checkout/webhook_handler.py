...
class StripeWH_Handler:
    ...
    def handle_payment_intent_succeeded(self, event):
        ...
        billing_details = intent.charges.data[0].billing_detiails
        ...
        try:
            order = Order.objects.get(
                ...
                street_address1__iexact=shipping_details.shipping_details.line1,
                street_address2__iexact=shipping_details.shipping_details.line2,
            ...
            try:
                ...
                order = Order.objects.create(
                    ...
                    street_address1=shipping_details.shipping_details.line1,
                    street_address2=shipping_details.shipping_details.line2,
